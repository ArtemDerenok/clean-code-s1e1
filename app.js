...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="current-list__item";
    //input (checkbox)
    ...
    label.className='current-list__name current-list__name_label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="current-list_checkbox";
    editInput.type="text";
    editInput.className="current-list__name current-list__name_input";
